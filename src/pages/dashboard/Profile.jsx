...
import { AiFillFacebook, AiFillGithub, AiFillInstagram, AiFillLinkedin, AiFillTwitterCircle, AiOutlineMail, AiOutlineUser } from "react-icons/ai";
  ...
  const handleImageChange = async (e) => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            console.error("Profile updted failed", error);
